...
@section('title', __("str.Add Product"))
@section('description',__("str.Add Product"))
@section('author',__("str.Add Product"))
@section('keywords',__("str.Add Product"))
@section('copyright',__("str.Add Product"))
@section('css')
@endsection
@php @endphp
@section('content')
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <li class="breadcrumb-item text-dark">{{__("str.Add Product")}}</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                    ...
                    <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body text-center pt-0">
                                ...
                                <div
                                    class="required text-muted fs-7">{{__("str.Set the product thumbnail image. Only *.png, *.jpg and *.jpeg image files are accepted and size 1M")}}
                                </div>
                                <!--end::Description-->
                            </div>
                            <!--end::Card body-->
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <!--end::Select2-->
                                <!--begin::Description-->
                                <div class="text-muted fs-7 mb-7">{{__("str.Add product to a product.")}}</div>
                                <!--end::Description-->
                                <!--end::Input group-->
                                <!--begin::Button-->
                                ...
                                <div class="d-flex flex-column gap-7 gap-lg-10">
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-10 fv-row">
                                                <!--begin::Label-->
                                                <label
                                                    class="required form-label">{{__("str.Product Name (Arabic)")}}</label>
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input id="product_name" type="text" name="product_name"
                                                       class="form-control mb-2"
                                                       placeholder="{{__("str.Product name")}}" value=""/>
                                                <!--end::Input-->
                                                <!--begin::Error-->
                                                ...
                                                <!--begin::Description-->
                                                <div
                                                    class="text-muted fs-7">{{__("str.A product name is required and recommended to be unique.")}}</div>
                                                <!--end::Description-->
                                            </div>
                                            <!--end::Input group-->
                                            <!--begin::Input group-->
                                            <div class="mb-10 fv-row">
                                                <!--begin::Label-->
                                                <label
                                                    class="required form-label">{{__("str.Product Name (English)")}}</label>
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <!--begin::Editor-->
                                                <textarea id=""
                                                          class="ckeditor_textarea form-control mb-2"></textarea>
                                                <input id="product_description" type="hidden"
                                                       class="ckeditor_value form-control mb-2" value="">
                                                <!--end::Editor-->
                                                <!--begin::Error-->
                                                ...
                                                <!--begin::Description-->
                                                <div
                                                    class="text-muted fs-7">{{__("str.Set a description to the product for better visibility.")}}
                                                </div>
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <!--begin::Editor-->
                                                <textarea id=""
                                                          class="ckeditor_textarea_en form-control mb-2"></textarea>
                                                <input id="product_description_en" type="hidden"
                                                       class="ckeditor_value_en form-control mb-2" value="">
                                                <!--end::Editor-->
                                                <!--begin::Error-->
                                    ...
                                    <div id="media" class="card card-flush py-4">
                                        ...
                                        <div class="card-body pt-0">
                                                ...
                                                <div class="dropzone" id="kt_ecommerce_add_product_media">
                                                    ...
                                                    <div class="dz-message needsclick">
                                                        ...
                                                        <div class="ms-4">
                                                            ...
                                                            <span
                                                                class="fs-7 fw-bold text-gray-400">{{__("str.Upload down to 6 files")}}</span>
                                                        </div>
                                                        <!--end::Info-->
                                                    </div>
                                                </div>
                                            ...
                                            <!--begin::Description-->
                                            <div
                                                class="text-muted fs-7">{{__("str.Set the product media gallery.")}}</div>
                                            <!--end::Description-->
                                        </div>
                                        <!--end::Card header-->
                                    </div>
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <input id="product_price" type="number" name="price"
                                                       ...
                                                       placeholder="{{__("str.Product price")}}" value=""/>
                                                <!--end::Input-->
                                                <!--begin::Error-->
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <div class="d-flex gap-3">
                                                    <input id="product_quantity" type="number" name="shelf"
                                                           class="text-start form-control mb-2"
                                                           placeholder="{{__("str.On shelf")}}" value=""/>
                                                ...
                                                <!--begin::Description-->
                                                <div
                                                    class="text-muted fs-7">{{__("str.Enter the product quantity.")}}</div>
                                                <!--end::Description-->
                                            </div>
                                            <!--end::Input group-->
                                            <!--begin::Input group-->
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="" data-kt-ecommerce-catalog-add-product="auto-options">
                                                <!--begin::Label-->
                                                <label class="form-label">{{__("str.Add Product Variations")}}</label>
                                                <!--end::Label-->
                                                <!--begin::Repeater-->
                                                <div id="kt_ecommerce_add_product_options">
                                                    ...
                                                    <div class="form-group mt-5">
                                                        <button type="button" data-repeater-create
                                                            ...
                                                            <!--end::Svg Icon-->{{__("str.Add another variation")}}
                                                        </button>
                                                    </div>
                                                    <!--end::Form group-->
                                                </div>
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-10">
                                                ...
                                                <!--begin::Description-->
                                                <div
                                                    class="text-muted fs-7">{{__("str.Set a meta tag title. Recommended to be simple and precise keywords.")}}
                                                </div>
                                                <!--end::Description-->
                                            </div>
                                            <!--end::Input group-->
                                            ...
                                            <div class="mb-10">
                                                <!--begin::Label-->
                                                <label
                                                    class="form-label">{{__("str.Meta Tag Description (Arabic)")}}</label>
                                                <!--end::Label-->
                                                <!--begin::Editor-->
                                                ...
                                                <!--begin::Description-->
                                                <div
                                                    class="text-muted fs-7">{{__("str.Set a meta tag description to the product for increased SEO ranking.")}}
                                                </div>
                                                <!--end::Description-->
                                            </div>
                                            <!--end::Input group-->
                                            ...
                                            <div class="mb-10">
                                                <!--begin::Label-->
                                                <label
                                                    class="form-label">{{__("str.Meta Tag Description (English)")}}</label>
                                                <!--end::Label-->
                                                <!--begin::Editor-->
...
@section('js')
    ...
    <script src="{{ asset('assets/js/product/create_product.js') }}" defer></script>
@endsection
