                        ...
                        t.preventDefault(), r && r.validate().then((function (t) {
                            ...
                            "Valid" == t ?
                                $.ajax({
                                    ...
                                    type: "get",
                                    url: $("#app_url").val() + "/report/products",
                                    data: {
                                        type: type,
                                        from: from,
                                        to: to,
                                    ...
                                    success: function (result, status, xhr) {
                                        ...
                                        (e.setAttribute("data-kt-indicator", "on"), e.disabled = !0, setTimeout((function () {
                                            e.removeAttribute("data-kt-indicator"), Swal.fire({
                                                ...
                                                var filename = (matches != null && matches[1] ? matches[1] : 'products.pdf');
                                                if (type == 1) {
                                                    filename = (matches != null && matches[1] ? matches[1] : 'products.xlsx');
                                                } else if (type == 2) {
                                                    filename = (matches != null && matches[1] ? matches[1] : 'products.csv');
                                                }
